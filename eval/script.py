...
def eval_2015(res_folder):
    ...
    params['g'] = gtfile
    params['s'] = submitfile
    result_metrics = rrc_evaluation_funcs.main_evaluation(params, default_evaluation_params, validate_data, evaluate_method)
    return result_metrics


def getresult(result_folder):
    # rrc_evaluation_funcs.main_evaluation(None, default_evaluation_params, validate_data, evaluate_method)
    #eval_2015('../../test')
    return eval_2015(result_folder)
